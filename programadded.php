...
?>
	...
	<body>
		<div id="page-container">
			...
			<h2 style="font-size:20px; color:#538b01; font-weight:bold; font-style:italic;"><b>Your Program information has been successfully added!</b></h2>
			<h4 style="font-size:14px; color:#000000; font-weight:bold; font-style:underline;"><b>Would you like to add a .pdf of your program?</b></h4>
			<form action='addpdf.php' method='POST' enctype='multipart/form-data'>
			<b style="font-size:14px; color:#000000; font-weight:bold; font-style:underline;">File:</b> <input type='file' name='myfile'> <input type='submit' name='submit' value='Upload!'> <input type='submit' name='no' value='No Thanks'>
			</form>
			</div>
			<div id="footer">
					<div id="altnav">
